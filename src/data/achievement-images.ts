...
export const achievementImages: Record<string, string> = {
  ...
  RepeatedlyDuplicateItems: `${STEAM_CDN_BASE}/1cb5bbf2d3be03c7d7195a3280de5c9f7ce8b8bd.jpg`, // ...Maybe One More.
  ...
  AutomationActivation: `${STEAM_CDN_BASE}/7e250fbdd7d5faa7c85a057f29af05e33c81ee24.jpg`, // Automation Activation
  ...
  DefeatFalseSon: `${STEAM_CDN_BASE}/0e8f9d0d95fa96371240816f9f1227cb4e6d947e.jpg`, // King of the Hill

  // ============================================
  // SURVIVOR UNLOCKS
  // ============================================
  RepeatFirstTeleporter: `${STEAM_CDN_BASE}/32df421f7ee3e8b6deb1ff809e634c19a969097c.jpg`, // Verified (MUL-T)
  CompleteTeleporterWithoutInjury: `${STEAM_CDN_BASE}/8e8b045585d45181db748d7afd76ff975591a0bf.jpg`, // Flawless
  ...
  UnlockFalseSon: `${STEAM_CDN_BASE}/7894f5def7de5e6b585532ec6cbf1f3cd2461c4a.jpg`, // Purified Freedom (False Son)
  FreeDrifter: `${STEAM_CDN_BASE}/46f8ea0158dafcbbacfdaf37b6141708a8067530.jpg`, // Lost in Transit (Drifter)

  // ============================================
  // COMMANDO SKILLS
  // ============================================
  CommandoKillOverloadingWorm: `${STEAM_CDN_BASE}/a952c416618e81fc2d8a360e0fb2d88cabff020e.jpg`, // Rolling Thunder
  CommandoFastFirstStageClear: `${STEAM_CDN_BASE}/ad8d62adb7786e7e9ec7c797caf3af593386dacd.jpg`, // Godspeed
  CommandoNonLunarEndurance: `${STEAM_CDN_BASE}/4bffe8934ba431589ea5ca69cdfc1755d15b5fb8.jpg`, // Incorruptible
  ...
  HuntressMaintainFullHealthOnFrozenWall: `${STEAM_CDN_BASE}/ff2b755b4d65d290e5012322997ab8c1c5ee6025.jpg`, // Piercing Wind
  ...
  ToolbotBeatArenaLater: `${STEAM_CDN_BASE}/e30215f787585c030edf69ae0e7d8b50d170c070.jpg`, // Seventh Day
  ...
  // ARTIFICER SKILLS
  // ============================================
  MageFastBoss: `${STEAM_CDN_BASE}/79cdda4e2fde84f7afae62af77443d0d150298c0.jpg`, // Chunked!
  MageMultiKill: `${STEAM_CDN_BASE}/d124457a8c5d041c0582c76c57a156ea6995f460.jpg`, // Massacre
  ...
  // LOADER SKILLS
  // ============================================
  LoaderSpeedRun: `${STEAM_CDN_BASE}/80de4cf13d504ea28aad2f226e9a222d73e546b8.jpg`, // Swing By
  LoaderBigSlam: `${STEAM_CDN_BASE}/238fb37aaf1b4ec3ce1440eb57655f0fb63846eb.jpg`, // Earthshatter
  LoaderKillLoaders: `${STEAM_CDN_BASE}/2428e7a16e72c66a6472d09c35b06af4632c0670.jpg`, // The Thunderdome

  // ============================================
  // ACRID SKILLS
  // ============================================
  CrocoKillWeakEnemiesMilestone: `${STEAM_CDN_BASE}/8e4c06833f22e1a41617d72a360411acd416c5f6.jpg`, // Easy Prey
  CrocoKillScavenger: `${STEAM_CDN_BASE}/371a585aa3971055b4983f3e7d878ecfd0963dce.jpg`, // Bad Medicine
  CrocoTotalInfectionsMilestone: `${STEAM_CDN_BASE}/e083f291d5677a2426f639d5cec6a8fe0ee9d333.jpg`, // Pandemic

  // ============================================
  // CAPTAIN SKILLS
  // ============================================
  CaptainSupplyDropFinale: `${STEAM_CDN_BASE}/500a3386b58986d8352d1580bffc2c9370e2b515.jpg`, // Smushed
  CaptainVisitSeveralStages: `${STEAM_CDN_BASE}/6613b2b7c7cbc5cd127c6578314e95c188a9de0b.jpg`, // Wanderlust
  CaptainBuyMegaDrone: `${STEAM_CDN_BASE}/0a290e61d496064f1a318467be8b82dc9780efd5.jpg`, // Worth Every Penny
  ...
  // ============================================
  RailgunnerConsecutiveWeakPoints: `${STEAM_CDN_BASE}/7b5f8bcae777f4daff576f1677639ae5c4d21d0a.jpg`, // Marksman
  RailgunnerDealMassiveDamage: `${STEAM_CDN_BASE}/b5e7d51f1a3d72307d5c43bc1370898dc2a3be07.jpg`, // Annihilator
  RailgunnerAirborneMultiKill: `${STEAM_CDN_BASE}/426d74811e1d6846e54a5c1adea8cfe5db8928eb.jpg`, // Trickshot

  // ============================================
  // SEEKER SKILLS (SOTS)
  // ============================================
  SeekerAirMultiHit: `${STEAM_CDN_BASE}/00c4aa0395997c9ba316e63698aa25dbb4e32570.jpg`, // Airborne Souls
  NukeSojourn: `${STEAM_CDN_BASE}/cd1f9ac5776b3164a3efe71dba803024a4a8b331.jpg`, // Scorched Earth
  SeekerPerfect20Meditation: `${STEAM_CDN_BASE}/2e1b720104aa263516904e69da209f78e0138c58.jpg`, // Clear Mind

  // ============================================
  // CHEF SKILLS (SOTS)
  // ============================================
  BurnMithrix: `${STEAM_CDN_BASE}/5a7335da8ee57fcfe6bac947124731ed0e919d6b.jpg`, // It's Getting Hot In Here!
  RolyPolyHitFiveAirEnemies: `${STEAM_CDN_BASE}/e693941be8f8c27cc84154ff93f99bbcd9ccac89.jpg`, // You've Always Been Crazy
  BarbecueQuantityBisonInRun: `${STEAM_CDN_BASE}/5d8b6afee91d036e3ae6a43b85103abedc4d0a93.jpg`, // Barbecued Bison Recipe Complete

  // ============================================
  // FALSE SON SKILLS (SOTS)
  // ============================================
  FalseSonLaserMultiKill: `${STEAM_CDN_BASE}/710fcafcbfbd43b22dac755627efb468a7085e6a.jpg`, // Stare Them Down
  FalseSonGrowthChallenge: `${STEAM_CDN_BASE}/f275549aba4b2d81c6c895889b1dd307e50a5882.jpg`, // Protein Heavy Diet
  FalseSonKillMithrixWithGoldenGal: `${STEAM_CDN_BASE}/65e7cdb61a41aba2a6c44d9e125ea935f2a1150f.jpg`, // Family Bonding

  // ============================================
  // OPERATOR SKILLS (AC)
  // ============================================
  DroneTechUniqueDrones: `${STEAM_CDN_BASE}/fa4e66b02e4a5fc34fd3282fb2e6b9727722e2b0.jpg`, // Putting Together a Team
  DroneTechTrickshot: `${STEAM_CDN_BASE}/5a7335da8ee57fcfe6bac947124731ed0e919d6b.jpg`, // That All You Got?
  DroneTechDefeatVultureBossWhileAirborne: `${STEAM_CDN_BASE}/fca973b6eb46b770160eebee59d7381a6d7ef913.jpg`, // Not So Different
  DroneTechJuggleLemurian: `${STEAM_CDN_BASE}/321298f4483dfe4fa064f6df91a0fd7ff638f0c5.jpg`, // That Just Happened

  // ============================================
  // DRIFTER SKILLS (AC)
  // ============================================
  DrifterJunkCubeAchievement: `${STEAM_CDN_BASE}/00bc7275a778bf43eecda1b24819bbce61dd42d5.jpg`, // Trash Compactor
  DrifterTornadoSlamAchievement: `${STEAM_CDN_BASE}/569d7169bb07b0a9d71b38d3edce933f0ffee94e.jpg`, // In The Bag
  ...
  // ============================================
  CommandoClearGameMonsoon: `${STEAM_CDN_BASE}/744db227744b51b85b4fc55baa4946d8fdbc2c0e.jpg`, // Commando: Mastery
  HuntressClearGameMonsoon: `${STEAM_CDN_BASE}/4ff28388bd2132b54967b4c02930699c6438f7a3.jpg`, // Huntress: Mastery
  ToolbotClearGameMonsoon: `${STEAM_CDN_BASE}/d87cff37e66fe880e70713d511890c7d94cc2b90.jpg`, // MUL-T: Mastery
  EngiClearGameMonsoon: `${STEAM_CDN_BASE}/0d7ed2d185c45f5f6fcc3c42dbb875faadac0ed4.jpg`, // Engineer: Mastery
  MageClearGameMonsoon: `${STEAM_CDN_BASE}/3db30f9c05d6a9e509358d4677ab81dbfa1fa274.jpg`, // Artificer: Mastery
  MercClearGameMonsoon: `${STEAM_CDN_BASE}/88f5e2c045178c2b2ce37e4d53207627dacb5deb.jpg`, // Mercenary: Mastery
  TreebotClearGameMonsoon: `${STEAM_CDN_BASE}/ab4167264591e737d4aea892eac384ec78c4f6b3.jpg`, // REX: Mastery
  LoaderClearGameMonsoon: `${STEAM_CDN_BASE}/22360d4dd318f4915e631291b99fe240a0deb489.jpg`, // Loader: Mastery
  CrocoClearGameMonsoon: `${STEAM_CDN_BASE}/92f067f53e4110b3d3e3e9f0f9635cf94ec21445.jpg`, // Acrid: Mastery
  CaptainClearGameMonsoon: `${STEAM_CDN_BASE}/73f8da70c536dab29a72e57df5dc1e678ff0cc8b.jpg`, // Captain: Mastery
  Bandit2ClearGameMonsoon: `${STEAM_CDN_BASE}/5cd9c5940fa89d37f15cb1b8db41936f5fb9aaee.jpg`, // Bandit: Mastery

  // ============================================
  // MASTERY SKINS (DLC)
  // ============================================
  RailgunnerClearGameMonsoon: `${STEAM_CDN_BASE}/d9836a468de7ee2229c612764360784efb943b89.jpg`, // Railgunner: Mastery
  VoidSurvivorClearGameMonsoon: `${STEAM_CDN_BASE}/8d4b2422cbe444ebeb1f556e9b31a82ff9b50c0d.jpg`, // Void Fiend: Mastery
  SeekerClearGameMonsoon: `${STEAM_CDN_BASE}/ec14a34f2499289b7c03eb19af43aa9d37ee58e7.jpg`, // Seeker: Mastery
  ChefClearGameMonsoon: `${STEAM_CDN_BASE}/28129f2cc820a97fd11c633e5a8e6877aa8084c2.jpg`, // CHEF: Mastery
  FalseSonClearGameMonsoon: `${STEAM_CDN_BASE}/3af631d2ecc56778b317d4b125917d28f96ed9e5.jpg`, // False Son: Mastery
  DroneTechClearGameMonsoon: `${STEAM_CDN_BASE}/73cf50c702fd89c52ab76bbd833f3d6c9cfca92f.jpg`, // Operator: Mastery
  DrifterClearGameMonsoon: `${STEAM_CDN_BASE}/0e01ef5e05db3a898d6f7d6e390d73c68128c941.jpg`, // Drifter: Mastery

  // ============================================
  // PRIME MERIDIAN EVENT SKINS (SOTS)
  // ============================================
  CommandoClearMeridianEvent: `${STEAM_CDN_BASE}/10ee7f100ffcfc334ec24eaba7d5a0cd29bbe774.jpg`, // Commando: Cleared Prime Meridian
  HuntressClearMeridianEvent: `${STEAM_CDN_BASE}/d3e8ed9f3da8d30643ec3613f7e9dd885756cfdd.jpg`, // Huntress: Cleared Prime Meridian
  ToolbotClearMeridianEvent: `${STEAM_CDN_BASE}/ca6dc99884433b83a0a68d294e6c5acfc84477d7.jpg`, // MUL-T: Cleared Prime Meridian
  EngiClearMeridianEvent: `${STEAM_CDN_BASE}/f893340fb7ffd91b6117a89c6c2d36741ea23c81.jpg`, // Engineer: Cleared Prime Meridian
  MageClearMeridianEvent: `${STEAM_CDN_BASE}/5a97b1d81860ced75b732b2ad43ade6e9c6f00af.jpg`, // Artificer: Cleared Prime Meridian
  MercClearMeridianEvent: `${STEAM_CDN_BASE}/8ef664e97a8754810e7af0304cf6f9ed7b5ac603.jpg`, // Mercenary: Cleared Prime Meridian
  TreebotClearMeridianEvent: `${STEAM_CDN_BASE}/7616d5441c5c1a7ae46b1246547f2ad18669eb7c.jpg`, // Rex: Cleared Prime Meridian
  LoaderClearMeridianEvent: `${STEAM_CDN_BASE}/682832b2e546d9d570908d7fc0f3ba987e9fa88f.jpg`, // Loader: Cleared Prime Meridian
  CrocoClearMeridianEvent: `${STEAM_CDN_BASE}/a6f75a48c8da1950c2fa19db64f4dda99101463f.jpg`, // Acrid: Cleared Prime Meridian
  CaptainClearMeridianEvent: `${STEAM_CDN_BASE}/48afb36adc34a33c03ba8e50bede2bef474686d4.jpg`, // Captain: Cleared Prime Meridian
  Bandit2ClearMeridianEvent: `${STEAM_CDN_BASE}/887c18928367480e30b721b3582c6a921139a71f.jpg`, // Bandit: Cleared Prime Meridian
  RailgunnerClearMeridianEvent: `${STEAM_CDN_BASE}/49406bbb571dd24f174926863b757c1a47bc6317.jpg`, // Railgunner: Cleared Prime Meridian
  VoidSurvivorClearMeridianEvent: `${STEAM_CDN_BASE}/b24c335622656a8adf3dd710a107c869f13d4e21.jpg`, // Void Fiend: Cleared Prime Meridian

  // ============================================
  // ALLOYED COLLECTIVE SKINS - PURGE (AC)
  // ============================================
  CommandoPurge: `${STEAM_CDN_BASE}/6a96f327290f1bbe50582e745d956308c4fe91bf.jpg`, // Commando: Purge
  HuntressPurge: `${STEAM_CDN_BASE}/7e502bfa72c9f50c5699675d02794c4b6210b696.jpg`, // Huntress: Purge
  ToolbotPurge: `${STEAM_CDN_BASE}/292aee798b1ff9ff6315aaca93484b0071ec09a1.jpg`, // MUL-T: Purge
  EngiPurge: `${STEAM_CDN_BASE}/053542336625ed65bdb8dae8bb98db8c45a8e6e7.jpg`, // Engineer: Purge
  MercPurge: `${STEAM_CDN_BASE}/1e72182343b60561b3acbcd9ae4486b4d399b4cf.jpg`, // Mercenary: Purge
  CrocoPurge: `${STEAM_CDN_BASE}/0d17d3d75a205e4d738b5f54ac38aecf2a23d649.jpg`, // Acrid: Purge

  // ============================================
  // ALLOYED COLLECTIVE SKINS - ACCEPT AND DECOMPILE (AC)
  // ============================================
  Bandit2Decompile: `${STEAM_CDN_BASE}/796ae737a149f94f7bf3e2ab07a0ab52d83406c8.jpg`, // Bandit: Accept and Decompile
  MageDecompile: `${STEAM_CDN_BASE}/55c323f6c11b17d591469ba979f9ca3cab1d55fd.jpg`, // Artificer: Accept and Decompile
  LoaderDecompile: `${STEAM_CDN_BASE}/d48708af28e6546e8bf0fe3beafbff5668228d65.jpg`, // Loader: Accept and Decompile
  CaptainDecompile: `${STEAM_CDN_BASE}/06cc46f4db2e15ff344afb74cb8cd40d5cf9d201.jpg`, // Captain: Accept and Decompile
  ...
  ObtainArtifactMixEnemy: `${STEAM_CDN_BASE}/27ba9780f6be4679dd3162ec70847160b9e7d151.jpg`, // Trial of Dissonance
  ObtainArtifactGlass: `${STEAM_CDN_BASE}/22cd0f43ad3cf260239a95f2eca3beb2d486cd76.jpg`, // Trial of Glass
  ObtainArtifactShadowClone: `${STEAM_CDN_BASE}/f77fbc916c1445e1b53c7977b0b5fc29159d9ab2.jpg`, // Trial of Vengeance
  ObtainArtifactFriendlyFire: `${STEAM_CDN_BASE}/76a9d8746704d66a862282b5ef16b64a5cf199cc.jpg`, // Trial of Chaos
  ObtainArtifactTeamDeath: `${STEAM_CDN_BASE}/d04993cf8e5f1b6c5ce34364e7d43262f02550b8.jpg`, // Trial of Death
  ObtainArtifactEnigma: `${STEAM_CDN_BASE}/f6ad0935eb2bab721fef80556778b3e4bd549f5a.jpg`, // Trial of Enigma
  ObtainArtifactRandomSurvivorOnRespawn: `${STEAM_CDN_BASE}/6bacc2d61aff797aba5d6ba34f294844b1be72c5.jpg`, // Trial of Metamorphosis
  ObtainArtifactBomb: `${STEAM_CDN_BASE}/e9cc254cdd780180e7e3e6938a48adc1d19f74e4.jpg`, // Trial of Spite
  ObtainArtifactWispOnDeath: `${STEAM_CDN_BASE}/e8d6e3f35e65f87ed6799ce6ba8493a0c6353f80.jpg`, // Trial of Soul
  ObtainArtifactMonsterTeamGainsItems: `${STEAM_CDN_BASE}/39c8e4e936270b27df937411fadd1f28fbb3b09d.jpg`, // Trial of Evolution
  ...
  ObtainArtifactDevotion: `${STEAM_CDN_BASE}/8bdd7f3fc362666e1e77a3372df060a3e3f14498.jpg`, // Trial of Devotion
  ObtainArtifactDelusion: `${STEAM_CDN_BASE}/3b84043904da84cbb6051e03f8cb0334ffd76cc6.jpg`, // Trial of Delusion
  ObtainArtifactPrestige: `${STEAM_CDN_BASE}/66f0659c71746f654540cd4a59e1c0d3380f4e19.jpg`, // Trial of Prestige
};
